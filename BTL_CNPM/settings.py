"""
Django settings for BTL_CNPM project.
...
SECRET_KEY = 'lt$)&jrw#ejvx+11j^s+pfapxe4_e@7)sxp(6vxieg5y1++y_c'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'questions.processor.cats_renderer',
            ],
        },
    },
]

WSGI_APPLICATION = 'BTL_CNPM.wsgi.application'
